...
html,body{margin:0;background:#0E6230}
.ic{width:${size}px;height:${size}px;background:#0E6230;display:flex;align-items:center;justify-content:center;flex-direction:column;gap:${size*0.02}px;font-family:BC;color:#fff;font-weight:800}
.go{font-size:${size*0.46}px;line-height:1;letter-spacing:.02em}
.sub{font-size:${size*0.13}px;letter-spacing:.14em;color:#8FE8AE;line-height:1}
.line{width:${size*0.5}px;height:${size*0.035}px;background:#8FE8AE;border-radius:${size}px}
